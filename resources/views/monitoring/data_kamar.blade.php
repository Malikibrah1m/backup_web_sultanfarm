...
<div class="card">
    <div class="card-body">
        <form action="{{ route('kamar.store') }}" method="post">
            @csrf
            <h5 class="fw-bold text-primary">Tambah Data Kamar</h5>
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="input-group">
                        <select class="form-control form-control-sm @error('id_plasma') is-invalid @enderror"
                            ...
                            <option value="{{ $value->id }}" {{ old('id_plasma')===$value->id ? 'selected' : '' }}>
                ...
                <div class="col-md-5">
                    ...
                    <input type="number" class="form-control  @error('no_kamar') is-invalid
                    @enderror" value="{{ old('no_kamar') }}" id="no_kamar_ke" name="no_kamar">
                    @error('no_kamar')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-5">
                <label class="text-sm" style="font-weight: 500;" for="">Kamar</label>
                <input type="number" class="form-control form-control-sm  @error('no_kamar') is-invalid
                    @enderror" value="{{ old('no_kamar') }}" id="no_kamar_ke" name="no_kamar">
                @error('no_kamar')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
        ...
        <table class="table" id="table1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <p class="text-lg-start" style="color: #3B484A; font-weight: 700">Plasma {{ $loop->iteration }}
                        </p>
                    </td>
                    <td>
                        List kamar <br>
                    ...
                    <div class="mb-3">
                        ...
                        <table class="table" id="table1">
                            ...
                            <tbody>
                                @foreach ($item->kamar as $value)
                                <tr>
                                    <form action="{{ url('admin/home/data_kamar/update/'.$value->id) }}" method="post">
                                        @csrf
                                        <td>{{ $loop->iteration }}</td>
                                        ...
                                        <td> <select class="form-control @error('status') is-invalid @enderror"
                                                ...
                                                <option value="Tersedia" {{ 'Tersedia'===old('status') ? 'selected' : ''
                                                    }}>
                                                    Tersedia
                                                </option>
                                                <option value="Tidak Tersedia" {{ 'Tidak Tersedia'===old('status')
                                                    ? 'selected' : '' }}>
                                        ...
                                        <td>
                                            <div class="btn-group ">
                                                <button type="submit" class="btn btn-sm btn-success" href=""

                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            @enderror" value="{{ old('kode') }}" id="kode" name="kode" placeholder="Ex: A"
                                autocomplete="off">
                            @error('kode')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @enderror" value="{{ old('gambar') }}" id="foto" name="gambar">
                            @error('gambar')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('urutan') is-invalid
                            @enderror" value="{{ old('urutan') }}" id="urutan" name="urutan">
                            @error('urutan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
@foreach ($data as $value)
<div class="modal fade text-left" id="modaledit{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="modaledit"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('admin/home/jenisdomba/update/'.$value->id) }}" method="post">
                    ...
                    <div class="mb-3">
                        <label for="jenis_domba">Jenis Domba</label>
                        <input type="text" class="form-control  @error('jenis_domba') is-invalid
                            @enderror" value="{{ old('jenis_domba', $value->jenis_domba) }}" id=" jenis_domba"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="kode">Kode</label>
                            <input type="text" class="form-control @error('kode') is-invalid
                            @enderror" value="{{ old('kode', $value->kode) }}" id="kode" name="kode"
                        ...
                        <div class="col-md-6">
                            <label for="urutan">Urutan</label>
                            <input type="number" class="form-control @error('urutan') is-invalid
                            @enderror" value="{{ old('urutan', $value->urutan) }}" id="urutan" name="urutan">
                            @error('urutan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

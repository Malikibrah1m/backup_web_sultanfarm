...
class MobileDombaController extends Controller
{
    ...
    public function domba_trading_tersedia(Request $request)
    {
        ...
        $dombas = Domba::select('dombas.*', 'jenis.jenis_domba as jenis_domba')
    ...
    function detail_paket_breeding($id) {
        $pakets = DataPaket::find($id);
        ...
        public function domba_saya(Request $request)
    {
        ...
        // Menggunakan metode join untuk menggabungkan tabel
        $dombas = Domba::select('dombas.id', 'dombas.kode_domba',
                                'dombas.nama_domba', 'dombas.jenis_kelamin',
                                'dombas.bobot', 'dombas.induk_jantan',
                                'dombas.induk_betina', 'dombas.turunan',
                                'dombas.gambar', 'dombas.keterangan',
                                'dombas.harga_beli', 'dombas.harga_jual',
                                'dombas.status', 'dombas.tgl_lahir',
                                'jenis_dombas.jenis_domba', 'jenis_dombas.kode',
                                'jenis_dombas.urutan', 'kamars.id_plasma',
                                'kamars.no_kamar', 'penjualans.id_customer',
                                'penjualans.total',)

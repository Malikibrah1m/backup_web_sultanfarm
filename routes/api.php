...
Route::get('/paket_breeding/{id}', [MobileDombaController::class, 'detail_paket_breeding']);

Route::get('/getPlasma', [MobileTransaksiController::class, 'getPlasma']);
...
Route::post('/updateCustomer', [MobileCustomerController::class, 'updateCustomer']);